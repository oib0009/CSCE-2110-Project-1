...
Thus, getting to the next student in the waiting list has a time complexity of O(1).



Finally, insertion of a new student to the end of the waiting list is O(1) if the end of the queue is tracked.
...
OperationData StructureTime ComplexityInsertion of a ReservationLinked ListO(n)Removal of a ReservationLinked ListO(n)Processing of Waiting ListQueueO(1)Undo a CancellationStack + Linked ListO(n)
